...
namespace EpiApp.Services.Services
{
        ...
        where TEntity : IBaseEntity
    {
        ...
        public TOutputModel Create<TInputModel, TOutputModel, TValidator>(TInputModel inputModel)
        ...
        public IEnumerable<TOutputModel> ListAll<TOutputModel>(bool tracking = true, IList<string>? includes = null) where TOutputModel : class
        {
